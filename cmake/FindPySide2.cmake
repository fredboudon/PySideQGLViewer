...
if(PYSIDE2_PRIV_FOUND)
    ...
    find_path(PYSIDE_INCLUDE_DIR
        pyside.h
        PATHS $ENV{CONDA_PREFIX}/include/PySide2 ${PYSIDE2_BASEDIR}/include ${PYSIDE_CUSTOM_PREFIX}/include/PySide2 
        NO_DEFAULT_PATH)
    ...
    find_file(PYSIDE_LIBRARY
        ...
        PATHS ${PYSIDE2_BASEDIR} ${PYSIDE_CUSTOM_PREFIX}/lib $ENV{CONDA_PREFIX}/lib
        NO_DEFAULT_PATH)

    find_path(PYSIDE_TYPESYSTEMS
        typesystem_core.xml
        PATHS ${PYSIDE2_BASEDIR}/typesystems ${PYSIDE_CUSTOM_PREFIX}/share/PySide2/typesystems $ENV{CONDA_PREFIX}/share/PySide2/typesystems
        NO_DEFAULT_PATH)
endif()
